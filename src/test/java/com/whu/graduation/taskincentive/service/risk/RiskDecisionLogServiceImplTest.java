...
class RiskDecisionLogServiceImplTest {
    ...
    void page_shouldApplyAllFiltersWhenProvided() {
        ...
        TaskConfigMapper taskConfigMapper = mock(TaskConfigMapper.class);
        RiskDecisionLogServiceImpl service = new RiskDecisionLogServiceImpl(mapper, userMapper, taskConfigMapper);
        ...
        Date end = new Date();
        Page<RiskDecisionLog> result = service.page(new Page<>(1, 20), 10L, null, null, null, "REJECT", start, end);
    ...
    void page_shouldSkipDecisionFilterWhenEmpty() {
        ...
        service.page(new Page<>(1, 20), null, null, null, null, "", null, null);
